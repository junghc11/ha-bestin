...
from .community import async_setup_community
from .energy_statistics import async_setup_energy_statistics
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if CONF_SESSION not in entry.data:
        ...
        await async_setup_energy_statistics(hass, entry, hub)
        await async_setup_community(hass, entry, hub)
